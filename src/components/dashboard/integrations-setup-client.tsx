      ...
      <div className="flex-1 flex items-center justify-center relative">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            ...
            <a href="/playground" className="w-full sm:w-auto px-8 h-12 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-[14px] font-bold shadow-[0_0_20px_rgba(99,102,241,0.3)] transition-all flex items-center justify-center">
        ...
        <div className="w-full lg:w-80 shrink-0 space-y-6">
          ...
          <div className="bg-[#0a0a0a] border border-white/[0.08] rounded-2xl p-6">
            ...
            <div className="space-y-3">
              ...
              <a href="/playground" className="flex items-center justify-between text-[13px] text-neutral-400 hover:text-white transition-colors group">
